...
import { fetchProductById } from '../firebase/productService';
  ...
  return (
    <div className="detail-container">
      <Link
        ...
        style={{ display: 'inline-flex', gap: '8px', marginBottom: '24px', cursor: 'pointer' }}
      >
        <ArrowLeft size={16} /> Volver al catálogo
      </Link>
      ...
      <div className="detail-layout">
        ...
        <div className="detail-info">
          ...
          <div className="detail-price">
            ...
            <span
              className={`detail-stock-badge ${producto.stock > 0 ? 'stock-ok' : 'stock-low'}`}
            >
